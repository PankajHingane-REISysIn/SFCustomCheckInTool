...
<body>
<div class="titleDiv"><s:text name="label.login"/></div>
<h1><s:property value="#title"/></h1>
<s:actionerror />
<s:actionmessage />
<s:form action="login" method="post">
    <s:textfield name="login.userName" value="%{login.userName}" label="%{getText('label.userName')}" size="40"/>
    <s:textfield name="login.password" value="%{login.password}" label="%{getText('label.password')}" size="40"/>
